...
# @pytest.mark.parametrize("num_parts", [1, 30])
# @pytest.mark.parametrize("ds_format", ["arrow", "arrow"])
...
#         {"A": "September", "B": 1, "count()": 7},
#         {"A": "September", "B": 2, "count()": 3},
#         {"A": "October", "B": 3, "count()": 10},
#         {"A": "December", "B": 1, "count()": 12},
#         {"A": "December", "B": 2, "count()": 8},
#     ]
...
@pytest.mark.parametrize("num_parts", [1, 30])
@pytest.mark.parametrize("ds_format", ["arrow"])
def test_global_tabular_sum(ray_start_regular_shared, ds_format, num_parts):
    seed = int(time.time())
    print(f"Seeding RNG for test_global_arrow_sum with: {seed}")
    random.seed(seed)
